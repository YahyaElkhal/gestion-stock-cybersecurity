...
<div class="d-flex justify-content-between align-items-center">
    <h1 class="m-0 text-dark">
        <i class="fas fa-edit"></i> Modifier le fournisseur : {{ $fournisseur->nom }}
    </h1>
...
<div class="container-fluid">
    ...
    <div class="card card-outline card-warning">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-truck"></i> Informations du fournisseur
            </h3>
        </div>
        
        <form method="POST" action="{{ route('fournisseurs.update', $fournisseur) }}" id="edit-supplier-form">
            @csrf
            @method('PUT')
            ...
            <div class="card-body">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" class="form-control @error('nom') is-invalid @enderror" 
                                   id="nom" name="nom" value="{{ old('nom', $fournisseur->nom) }}" 
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('adresse') is-invalid @enderror" 
                              ...
                              placeholder="Adresse complète du fournisseur">{{ old('adresse', $fournisseur->adresse) }}</textarea>
                    @error('adresse')
                        <span class="invalid-feedback" role="alert">
                            <strong>{{ $message }}</strong>
                        </span>
            ...
            <div class="card-footer text-right">
                <a href="{{ route('fournisseurs.index') }}" class="btn btn-danger mr-2">
...
$(document).ready(function() {
    ...
    $('#edit-supplier-form').submit(function() {
