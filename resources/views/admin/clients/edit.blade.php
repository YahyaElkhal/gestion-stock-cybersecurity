...
<div class="d-flex justify-content-between align-items-center">
    <h1 class="m-0 text-dark">
        <i class="fas fa-user-edit"></i> Modifier le client : {{ $client->nom }}
    </h1>
...
<div class="container-fluid">
    ...
    <div class="card card-outline card-warning">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-info-circle"></i> Informations du client (ID: #{{ str_pad($client->id, 5, '0', STR_PAD_LEFT) }})
            </h3>
        </div>
            ...
            <div class="card-body">
                ...
                <div class="form-group">
                    ...
                    <textarea class="form-control @error('adresse') is-invalid @enderror" 
                              ...
                              placeholder="Saisissez l'adresse complète...">{{ old('adresse', $client->adresse) }}</textarea>
                    @error('adresse')
                        <div class="invalid-feedback">{{ $message }}</div>
                    @enderror
                </div>
