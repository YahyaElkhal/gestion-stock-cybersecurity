...
<div class="container-fluid">
    ...
    <div class="card card-outline card-warning">
        <div class="card-header">
            <h3 class="card-title">
                <i class="fas fa-box-open"></i> Informations du produit
            </h3>
        </div>
        
        <form action="{{ route('produits.update', $produit) }}" method="POST" id="edit-product-form">
            @csrf
            @method('PUT')
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="number" name="quantite_en_stock" id="quantite_en_stock" 
                                   ...
                                   value="{{ old('quantite_en_stock', $produit->quantite_en_stock) }}" 
                                   min="0" 
                                   required>
            ...
            <div class="card-footer text-right">
                <a href="{{ route('produits.index') }}" class="btn btn-danger mr-2">
